...
async function loadFonts() {
    ...
    const sfProRegularPath = path.join(FONT_DIR, 'SF-Pro-Display-Regular.otf');
    if (fs.existsSync(sfProRegularPath)) {
        GlobalFonts.registerFromPath(sfProRegularPath, 'SF Pro Regular');
